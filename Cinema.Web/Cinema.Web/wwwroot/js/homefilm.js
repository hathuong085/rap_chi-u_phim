            ...
            $("#addbookbody").append(
                `
                     <table id="bookseat">
                        ...
                        <tr>
                            <td></td>
                            <td width = "50" height = "30" style="text-align:center;padding-top:7px"><input type='button' style="width:20px;height:20px;background-color:red" value=''></td>
                            <td  colspan="3" style="font-size:11px">Đã sử dụng</td>
                            <td width = "50" height = "30" style="text-align:center;padding-top:7px"><input type='button' style="width:20px;height:20px;background-color:greenyellow" value=''></td>
                            <td colspan="2" style="font-size:11px">Đang chọn</td>
                            <td width = "50" height = "30" style="text-align:center;padding-top:7px"><input type='button' style="width:20px;height:20px;" value=''></td>
                            <td colspan="2" style="font-size:11px">Ghế trống</td>
                        <tr>
                        <tr id="numberseat">
